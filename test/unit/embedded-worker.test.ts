...
} from '../../src/embedded/native-call.js';
import type {
  Decode,
  NativeCallRequest,
  NativeCallResponse,
...
import { RETURN_KIND } from '../../src/embedded/native-binding.js';
import type { NativeBinding, NativeCallableFn } from '../../src/embedded/native-binding.js';
import { v1AbiMessage, loadFailureMessage } from '../../src/embedded/ffi.js';
import { NativeEngine } from '../../src/embedded/native.js';
import type { WorkerLike } from '../../src/embedded/native.js';
import type { FromWorkerMessage, ToWorkerMessage } from '../../src/embedded/protocol.js';
